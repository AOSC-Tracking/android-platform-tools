# Tracking repository for android-platform-tools (upstream name android-tools)

## Standard Operation Procedure

1. Download a source archive of android-tools from <https://github.com/nmeum/android-tools/releases/>. Normally the URL is <https://github.com/nmeum/android-tools/releases/download/$VER/android-tools-$VER.tar.xz>, replacing "$VER" with the version to be imported, like `35.0.2`.
